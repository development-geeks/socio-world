...
const CustomButton = ({
  ...
  // Variant styles
  const variantStyles = {
    primary: "bg-blue-500 w-full text-white hover:bg-blue-600 focus:ring-blue-400",
    secondary: "bg-gray-500 w-full text-white hover:bg-gray-600 focus:ring-gray-400",
    danger: "bg-red-500 w-full text-white hover:bg-red-600 focus:ring-red-400",
    success: "bg-green-500 w-full text-white hover:bg-green-600 focus:ring-green-400",
  };
